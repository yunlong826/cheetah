...
import com.cheetah.message.common.dto.model.DingDingWorkContentModel;
...
import com.cheetah.message.handler.provider.account.DingDingWorkNoticeAccount;
import com.cheetah.message.handler.provider.config.SupportThreadPoolConfig;
...
/**
 * Description: 钉钉工作消息自定义机器人 消息处理器
 * 参考文档 钉钉工作消息自定义机器人文档：https://open.dingtalk.com/document/group/custom-robot-access
 *
 * @author longyun
 * @version 1.0
 * @date 2022/8/1 21:07
